...
class Order extends BaseModel
{
    ...
    /** 
     *    create order in orders table and get that id
    ...
    function createAndGetOrder(string $paymentMethod, int $userId) : int
    {
        ...
        Log::logInfo("createAndGetOrder method of Order executed with parameters -  user id: $userId, payment method: $paymentMethod");
    ...
    function getOrders(int $userId) : array
    {
        ...
        Log::logInfo("getOrders method of Order executed with parameters -  user id: $userId");
