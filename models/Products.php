...
class Products extends BaseModel
{
    ...
    function getProductsByLimit(int $start,int $length,string $searchValue, string $orderColumn, string $order) : array
    {
        ...
        Log::logInfo("executing getProductsByLimit with parameters - $start, $length, $searchValue at Products");
    ...
    function insertProductsAsInFile() : void
    {
        ...
        Log::logInfo("executed insertProductsAsInFile successfully at Products");
    }
